...
module Test.Dawn.Compiler.MidIR.Regression (spec) where
...
import Dawn.Compiler.TypedCore (Constraint(..), Decl(..), Expr(..), Ident(..), Kind(..), Literal(..), Module, ModuleName(..), Qualified(..), RowEntry(..), RowKey(..), Symbol(..), TyVar(..), Type(..), declareAnnotated, intTy, monoScheme, primSignature, pureFn, recordTy, variantTy)
...
spec :: Spec Unit
spec = describe "Dawn.Compiler.MidIR.Translate » cases a plausible translation gets wrong" do
