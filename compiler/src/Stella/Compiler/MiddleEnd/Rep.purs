...
import Stella.Compiler.TypedCore.Prim (booleanTy, charTy, functionTy, intTy, numberTy, recordTy, stringTy, variantTy)
import Stella.Compiler.TypedCore.Signature (CanonicalClass(..), Signature, TyConInfo(..), lookupTyCon)
